...
export function CNavigationAction({
    ...
    return (
        <Action
            {...useChocoProps(prop, ({ size, mixCsProps, getSetClrProps }) => {
                ...
                return {
                    cs: {
                        ...
                        minW: size({ calc: (size) => size * 5 }),
                        maxW: size({ calc: (size) => size * 10 }),
                        '&.Mui-selected': {
                            ...styles,
                            fontS: size({ calc: (size) => size * 1.2 }),
                        },
