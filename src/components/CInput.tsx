            ...
            {...useChocoProps(prop, ({ size, theme }) => {
                ...
                const getMargin = (time: number = 1) =>
                    size(
                        (size) =>
                            `${
                                size * theme.root.response.padding * time
                            }px !important`,
                        padding,
                    );
    ...
    return (
        <FormControl
            ...
            {...useChocoProps(
                props?.control ?? {},
                ({ size, theme, isSize }) => {
                    const { border, padding } = theme.root.size;
                    ...
                    return {
                        cs: {
                            '& .MuiInputBase-root': {
                                ...
                                '& fieldset': {
                                    borders: borders(0.5),
                                    px: size((size) => size * 0.75, padding),
                                    '& legend': {
                                        h: size((size) => size * 0.75),
                                        '& span': {
                                            fontS: size((size) => size),
                                        },
                                    },
                                },
                                '&:before': {
