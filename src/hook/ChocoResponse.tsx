    ...
    static useChocoStyle<Styles extends StyledType | SxType>(): (
        ...
        return useCallback((styles: StyleTypes = {}): Styles => {
            ...
            const toSize = (
                ...
                if (typeof value === 'number') return `${value * time}${unit}`;
                if (isSize(value)) {
            ...
            const toBorder = (border: LinesStyleType | string | undefined) => {
                ...
                if (border) {
                    ...
                    const borderSize = toSize(size ?? width ?? 8);
            ...
            //* Width and Height
            setCss('width', toSize(styles.w));
            setCss('height', toSize(styles.h));
            setCss('minWidth', toSize(styles.minW));
            setCss('minHeight', toSize(styles.minH));
            setCss('maxWidth', toSize(styles.maxW));
            setCss('maxHeight', toSize(styles.maxH));
            //* inset
